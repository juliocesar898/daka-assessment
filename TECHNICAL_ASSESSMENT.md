...
Esta es una prueba técnica diseñada para evaluar tus habilidades como desarrollador Full-Stack. Deberás completar una aplicación web que incluye autenticación de usuarios y visualización en tiempo real de sprites de Pokémon utilizando **NestJS** (backend) y **Next.js** (frontend).
